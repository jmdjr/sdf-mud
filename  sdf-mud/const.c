...
const struct race_type _race_table[MAX_RACE] = {
   ...
   {
    "Dwarf", {{1 << AFF_INFRARED, 0, 0, 0}}, 1, 0, 1, 0, 2, -1, 0, 6, -6, 0, 0, ( 1 << CLASS_MAGE ) | ( 1 << 8 ),
    LANG_DWARVEN},

   {
    "Halfling", {{1 << AFF_SNEAK, 0, 0, 0}}, -2, 1, 0, 0, 1, 0, 0, -3, 10, 0, 0,
    ( 1 << CLASS_MAGE ) | ( 1 << CLASS_DRUID ) | ( 1 << CLASS_CLERIC ) | ( 1 << CLASS_AUGURER ) | ( 1 << 8 ), LANG_HALFLING},

   {
    "Pixie", {{1 << AFF_FLYING, 0, 0, 0}}, -4, 3, 0, -1, -2, 3, 0, -5, 40, 0, 0,
    ( 1 << CLASS_WARRIOR ) | ( 1 << 8 ) | ( 1 << CLASS_AUGURER ),
    LANG_PIXIE},
    ...
    */
   {
    ...
    ( 1 << CLASS_MAGE )
    | ( 1 << CLASS_CLERIC ) | ( 1 << CLASS_DRUID ) | ( 1 << CLASS_AUGURER ) | ( 1 << CLASS_RANGER ) | ( 1 << 8 ), LANG_OGRE},
...

   {
    ...
    ( 1 << CLASS_MAGE )
    | ( 1 << CLASS_CLERIC )
    | ( 1 << CLASS_DRUID ) | ( 1 << CLASS_AUGURER ) | ( 1 << CLASS_RANGER ) | ( 1 << 8 ), LANG_ORCISH},

   {
    "Half-Troll", {{1 << AFF_INFRARED, 0, 0, 0}}, 3, -2, -2, 1, 2, -5, 0, 7, -9, 0, 0,
    ( 1 << CLASS_MAGE ) | ( 1 << CLASS_CLERIC ) | ( 1 << CLASS_DRUID ) | ( 1 << CLASS_RANGER ) | ( 1 << 8 ),
    LANG_TROLLISH},
    ...
    LANG_ELVEN},
   {
    ...
    ( 1 << CLASS_DRUID ) | ( 1 << CLASS_RANGER ) | ( 1 << 8 ),
    LANG_GITH},
   {
    "Centaur", {{1 << AFF_SCRYING, 0, 0, 0}}, 2, -4, -1, +2, +1, -2, 0, 5, 0, 0, 0,
    ( 1 << CLASS_MAGE ) | ( 1 << CLASS_CLERIC ) | ( 1 << CLASS_THIEF ) | ( 1 << CLASS_DRUID ) | ( 1 << CLASS_AUGURER ),
    LANG_COMMON},
   {
   ...
   {
    "Slith", {{1 << AFF_INFRARED, 0, 0, 0}}, 1, 0, 1, 0, 2, -1, 0, 6, -6, 0, 0, ( 1 << CLASS_MAGE ) | ( 1 << 8 ),
    LANG_DWARVEN},
   {
...
char *const npc_race[MAX_NPC_RACE] = {
   "human", "elf", "dwarf", "halfling", "pixie", "vampire", /* 6 */
   "half-ogre", "half-orc", "half-troll", "half-elf", "gith", "drow",   /* 12 */
   "sea-elf", "lizardman", "gnome", "minotaur", "sprite", "leprechaun", /* 18 */
   "kender", "ariel", "centaur", "slith", "mrrshan", "wraith", /* 24 */
   "harpy", "goblin", "kobold", "nymph", "troglodyte", "gargoyle",   /* 30 */
   "Immortal", "Green", "Black", "White", "Blue", "Red", /* 36 */
   "Gold", "Silver", "Bronze", "Copper", "golem", "vampire",   /* 42 */
   "harpy", "hobgoblin", "kobold", "lizardman", "locust", "lycanthrope",   /* 48 */
   "minotaur", "mold", "mule", "neanderthal", "ooze", "orc",   /* 54 */
   "rat", "rustmonster", "shadow", "shapeshifter", "shrew", "shrieker", /* 60 */
   "skeleton", "slime", "snake", "spider", "stirge", "thoul",  /* 66 */
   "troglodyte", "undead", "wight", "wolf", "worm", "zombie",  /* 72 */
   "bovine", "canine", "feline", "porcine", "mammal", "rodent",   /* 78 */
   "avis", "reptile", "amphibian", "fish", "crustacean", "insect",   /* 84 */
   "spirit", "magical", "horse", "animal", "humanoid", "monster", /* 90 */
   "god"
};
