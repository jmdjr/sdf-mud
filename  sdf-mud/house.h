 ...
 */
#define ADDED_ROOM_HOUSING_AREA "Mortal Homes"

/* Location of housing directory */
#define HOUSE_DIR             "../homes/"
/* Location of housing list for loadup of houses */
#define HOUSE_LIST            HOUSE_DIR "homes.lst"
